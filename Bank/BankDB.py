...
bankUser.AddBankUser(2)
account.AddAccount(2,1,True,10000)
deposit.AddDeposit(2,4444)
# userAccount = account.GetAccount(2)
print(account.GetAccount(2))
deposits = deposit.GetDeposits(2)
for x in deposits:
    print(x[0])
loan.CreateLoan(2, 200)
